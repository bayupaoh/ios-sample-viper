...
class SSRadioButton: UIButton {
    ...
    */
    ...
    fileprivate func initialize() {
        ...
        self.titleEdgeInsets = UIEdgeInsetsMake(0, (4*circleRadius + 4*circleLayer.lineWidth) + 8, 0, 0)
        self.toggleButon()
    }
    /**
...
//            fillCircleLayer.fillColor = circleColor.cgColor
    ...
    override func layoutSubviews() {
        ...
        self.titleEdgeInsets = UIEdgeInsetsMake(0, (2*circleRadius + 4*circleLayer.lineWidth) + 8, 0, 0)
    }
