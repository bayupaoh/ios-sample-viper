...
- (void)commonInit {
    ...
    self.hmBorderColor = [UIColor blackColor];
    self.hmBorderWidth = 1.0f;
...
- (void)addBackgroundAndBorderLayerWithRect:(CGRect)fullRect {
    ...
    if (self.borderType & HMSegmentedControlBorderTypeTop) {
        ...
        borderLayer.frame = CGRectMake(0, 0, fullRect.size.width, self.hmBorderWidth);
        borderLayer.backgroundColor = self.hmBorderColor.CGColor;
        [backgroundLayer addSublayer: borderLayer];
    }
    if (self.borderType & HMSegmentedControlBorderTypeLeft) {
        CALayer *borderLayer = [CALayer layer];
        borderLayer.frame = CGRectMake(0, 0, self.hmBorderWidth, fullRect.size.height);
        borderLayer.backgroundColor = self.hmBorderColor.CGColor;
        [backgroundLayer addSublayer: borderLayer];
    }
    if (self.borderType & HMSegmentedControlBorderTypeBottom) {
        CALayer *borderLayer = [CALayer layer];
        borderLayer.frame = CGRectMake(0, fullRect.size.height - self.hmBorderWidth, fullRect.size.width, self.hmBorderWidth);
        borderLayer.backgroundColor = self.hmBorderColor.CGColor;
        [backgroundLayer addSublayer: borderLayer];
    }
    if (self.borderType & HMSegmentedControlBorderTypeRight) {
        CALayer *borderLayer = [CALayer layer];
        borderLayer.frame = CGRectMake(fullRect.size.width - self.hmBorderWidth, 0, self.hmBorderWidth, fullRect.size.height);
        borderLayer.backgroundColor = self.hmBorderColor.CGColor;
        [backgroundLayer addSublayer: borderLayer];
    }
}
