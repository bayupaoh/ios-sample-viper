...
extension UIViewController {
    ...
    func setupBackBarButtonItems(title: String? = "", closeButton close: Bool = false, customCloseButton imageClose: UIImage? = nil, tintColor: UIColor? = UIColor.white) {
...
//        setupTitle(title)
        ...
        buttonSearch.setImage(UIImage(named:"ic_search"), for: UIControlState.normal)
        buttonSearch.addTarget(self, action: #selector(buttonSearchPressed), for: UIControlEvents.touchUpInside)
